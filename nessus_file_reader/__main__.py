...
@click.option("--scan-file-source", is_flag=True, help="Source of scan file e.g. Nessus, Tenable.sc, Tenable.io")
...
def scan(files, scan_summary, scan_summary_legend, scan_file_source, policy_summary):
            ...
            for file in files:
                ...
                for row_index, nessus_scan_file in enumerate(list_of_source_files):
                    ...
                    if policy_summary:
                        ...
                        policy_summary_data.append({'File name': nessus_scan_file,
                    ...
                    if scan_file_source:
                        ...
                        scan_file_source_data.append({'File name': nessus_scan_file,
                    ...
                    if scan_summary:
                        ...
                        summary_data.append({'File name': nessus_scan_file,
    ...
    if scan_summary_legend:
        ...
        print("CC - number of hosts scanned with credentials (Credentialed checks yes in Plugin ID 19506)")
